...
function App() {
  ...
  return (
    ...
    <div className="App">
      ...
      <Tabs color={'default'} aria-label="Tabs colors" radius="full" size='lg' variant='solid' style={{ color: 'white', padding: '10px' }}>
        <Tab key="about" title="About Me" style={{margin: '3px'}}/>
        <Tab key="experience" title="Experience" />
        <Tab key="projects" title="Projects" />
        <Tab key="skills" title="Skills" />
        <Tab key="contact" title="Contact Me" style={{margin: '3px'}}/>
      </Tabs>
    </div>
        <Stack style={{ paddingTop: "75px", width: "70%", justify: 'center' }}>
            ...
            <Group style={{ paddingBottom: "50px"}}>
              ...
              <Stack  ml={25}>
                ...
                <TypeAnimation
                  ...
                  speed={50}
                  deletionSpeed={70}
                  style={{ fontSize: "50px", fontWeight: "bold", marginRight: 'auto' }}
                  repeat={Infinity}
                />
    ...
    <Button  style={{marginRight: 'auto', backgroundColor: "#004493"}}>
      <LinkedInIcon/>
      Linkedin
    </Button>
    <Button style={{marginRight: 'auto', backgroundColor: '#18181B'}}>
      <GitHubIcon/>
      Github
    </Button>
    </Group>
    ...
    </Card>            <section id="projects">PROJECTS</section>
...
the car's movement"
          ...
          <Group
            w={1000}
            style={{ justifyContent: "space-around" }}></Group>
